...
<section class="portafolio center-vertical">
    <div class="contenedor">
        <h2>Portafolio</h2>
        <div class="proyectos">
            <a href="#proyecto1" class="proyecto popup-with-zoom-anim" title="BODHILAB">
                <img src="<?php echo IMG;?>/services/img-141.jpg" alt="BODHILAB" title="BODHILAB">
                <h3>BODHILAB</h3>
            </a>
            <a class="proyecto popup-with-zoom-anim" title="BOTANIA">
                <img src="<?php echo IMG;?>/services/img-140.jpg" title="BOTANIA" alt="BOTANIA">
                <h3>BOTANIA</h3>
            </a>
            <a class="proyecto popup-with-zoom-anim" title="SERCOM">
                <img src="<?php echo IMG;?>/services/img-139.jpg" title="SERCOM" alt="SERCOM">
                <h3>SERCOM</h3>
            </a>
        </div>
    </div>
                ...
                <ul class="splide__list">
                    <li class="splide__slide web">
                        <div class="web_content">
                            ...
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Obtén tu manual de identidad">
                                <p>¡Quiero mi branding!</p>
                                <div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-147.jpg" title="Obtén tu manual de identidad" alt="Obtén tu manual de identidad">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>HAZ UN</span>
                                <span>REBRANDING DE</span>
                                <span>TU MARCA</span>
                            </h2>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Haz un rebranding de tu marca">
                                <p>¡Quiero mi branding!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-149.jpg" title="Haz un rebranding de tu marca" alt="Haz un rebranding de tu marca">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>OBTÉN TU</span>
                                <span>PROPIA PAPELERÍA</span>
                                <span>CORPORATIVA</span>
                            </h2>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Obtén tu propia papelería corporativa">
                                <p>¡Quiero mi branding!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-148.jpg" title="Obtén tu propia papelería corporativa" alt="Obtén tu propia papelería corporativa">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>OBTÉN TU</span>
                                <span>PROPIO PACKAGING</span>
                                <span>CORPORATIVA</span>
                            </h2>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Obtén tu propia packaging corporativa">
                                <p>¡Quiero mi branding!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-150.jpg" title="Obtén tu propia packaging corporativa" alt="Obtén tu propia packaging corporativa">
                        </div>
                    </li>
                </ul>
            </div>
