    ...
    <div class="contenedor">
        ...
        <div class="proyectos">
            <a href="#proyecto1" class="proyecto popup-with-zoom-anim" title="Solventa">
                <img src="<?php echo IMG;?>/services/img-156.jpg" title="Solventa" alt="Solventa">
                <h3>SOLVENTA</h3>
            </a>
            <a class="proyecto popup-with-zoom-anim" title="GRM">
                <img src="<?php echo IMG;?>/services/img-159.jpg" title="GRM" alt="GRM">
                <h3>GRM</h3>
            </a>
            <a class="proyecto popup-with-zoom-anim" title="AC LAB">
                <img src="<?php echo IMG;?>/services/img-154.jpg" title="AC LAB" alt="AC LAB">
                <h3>AC LAB</h3>
            </a>
        </div>
    </div>
                ...
                <ul class="splide__list">
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>QUE TU FEED</span>
                                <span>DE INSTAGRAM</span>
                                <span>HABLE POR TI</span>
                            </h2>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Que tu feed de Instagram hable por ti">
                                <p>¡Quiero mis redes!</p>
                                <div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-162.jpg" title="Que tu feed de Instagram hable por ti" alt="Que tu feed de Instagram hable por ti">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>VENDE MÁS</span>
                                <span>CON UNA PÁGINA</span>
                                <span>DE FACEBOOK PARA</span>
                                <span>TU EMPRESA</span>
                            </h2>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Vende más con una página de Facebook para tu empresa">
                                <p>¡Quiero mis redes!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-161.jpg" title="Vende más con una página de Facebook para tu empresa" alt="Vende más con una página de Facebook para tu empresa">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                <span>¿TIENES OTRA</span>
                                <span>RED SOCIAL?</span>
                            </h2>
                            <p>¡Nosotros te ayudamos a administrarla!</p>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="¿Tienes otra red social?">
                                <p>¡Quiero mis redes!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-163.jpg" title="¿Tienes otra red social?" alt="¿Tienes otra red social?">
                        </div>
                    </li>
                    <li class="splide__slide web">
                        <div class="web_content">
                            <h2>
                                ...
                                <span>A MANEJAR</span>
                                <span>LAS CRISIS</span>
                            </h2>
                            <p>a través del contenido perfecto para tus redes!</p>
                            <a href="<?php echo esc_url(home_url('contactanos'));?>" class="custom blue" title="Te ayudamos a manejar las crisis">
                                <p>¡Quiero mis redes!</p>
                                <div>
                                    <img src="<?php echo IMG;?>/large-arrow.svg" title="Large Icon Arrow" alt="Large Icon Arrow">
                                </div>
                        ...
                        <div class="web_preview">
                            <img src="<?php echo IMG;?>/services/img-160.jpg" title="Te ayudamos a manejar las crisis" alt="Te ayudamos a manejar las crisis">
                        </div>
                    </li>
                </ul>
            </div>
