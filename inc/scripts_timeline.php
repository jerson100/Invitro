<script src="<?php echo JS?>/tl/gsap.min.js"></script>
<script src="<?php echo JS?>/tl/ScrollMagic.min.js"></script>
<script src="<?php echo JS?>/tl/debug.addIndicators.min.js"></script>
<script src="<?php echo JS?>/tl/animation.gsap.min.js"></script>
<script src="<?php echo JS?>/tl/TweenLite.min.js"></script>
<script src="<?php echo JS?>/tl/TimelineLite.min.js"></script>
<script src="<?php echo JS?>/tl/CSSPlugin.min.js"></script>
<script async src="<?php echo JS?>/tl/ScrollTrigger.min.js"></script>
